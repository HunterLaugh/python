...
class Game(object):
	...
	def play(self):
		...
		while True:
			...
			print("getattr(self,next)",getattr(self,next))
			next=room()
	...
	def printcess_lives_here(self):
		...
		if eat_it=="eat it":
			...
			print("She points to a tiny door and says, 'The Koi nees cake too.'")
			print("She gives you the very last bit of cake and shoves you in.")
			return 'gold_koi_pond'
			
		else:
			print("The princess looks at you confused and just points at the cake.")
			return 'printcess_lives_here'
	...
	def gold_koi_pond(self):
		...
		if feed_it=="feed it":
			...
			print("It ruses to the other end of the pond, braces against the wall...")
			...
			print("You can see it's happy, it then gruns, thrashes...")
	...
	def big_iron_gate(self):
		print("You walk up to the big iron gate and see there's a bandle.")
...
a_game=Game("printcess_lives_here")
a_game.play()