# coding:utf-8
# 基于python 2.7
# 网站 http://www.code123.cc/1049.html
# 修订加入python3.0相关特性   @Hunter为修订
...
print("I'm Python. Nice to meet you!")  # @Hunter  python 3.0 version
...
# 使用 pop(2) 来移除一个元素li[2]  @Hunter				
li.pop(2)       #=> 3 and li is now [1, 2]
                #=> 3，然后 li 现在是 [1, 2]
# Let's put it back
# 我们再把它放回去  @Hunter 
li.append(4)    # li is now [1, 2, 4] again.
                # li 现在又是 [1, 2, 4] 了
# 我们再把它放回去  @Hunter 
...
# 你可以使用切片语法来查询列表的一个范围。
# （这个范围相当于数学中的左闭右开区间。）
li[1:3] #=> [2, 4]  @Hunter li[1:3] is li[1] and li[2] 左闭右开区间 >= and <
# Omit the beginning
# 省略结尾  @Hunter
li[2:] #=> [4, 3]
# Omit the end
